...
--
-- Host: localhost:8081
-- Generation Time: Feb 10, 2021 at 05:02 PM
...
CREATE TABLE `arrets` (
  ...
  `nom_arret` varchar(20) NOT NULL,
  `adresse_arret` varchar(50) NOT NULL
...
INSERT INTO `arrets` (`id_arret`, `nom_arret`, `adresse_arret`) VALUES
...
CREATE TABLE `bus` (
  ...
  `numero_bus` varchar(4) NOT NULL,
  `immatriculation_bus` varchar(7) NOT NULL,
  `nombre_place_bus` int(11) NOT NULL,
  `id_ligne` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `bus` (`id_bus`, `numero_bus`, `immatriculation_bus`, `nombre_place_bus`, `id_ligne`) VALUES
(1, 'BB01', 'CA123DO', 20, 1),
(2, 'BB02', 'NO123EL', 30, 2),
(3, 'BB03', 'JE123UX', 20, 3),
(4, 'BB04', 'RE123PA', 30, 1),
